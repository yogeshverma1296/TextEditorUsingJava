...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        JLabel l3 = new JLabel("<html>Developed by Yogesh Verma<br>Java Project<br>All rights reserved<br><br>Notepad is a word processing program, <br>which allows changing of text in a computer file.<br>Notepad is a simple text editor for basic text-editing program<br> which enables computer users to create documents. </html>");
